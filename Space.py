...
class Nave (pygame.sprite.Sprite):
    def __init__(self,y):
        ...
        self.image = carga_imagenes("imagenes/baseshipb.ico",True)
...
class Disparo (pygame.sprite.Sprite):
    ...
    def __init__(self,posicion):
        pygame.sprite.Sprite.__init__(self)
        self.image = carga_imagenes("imagenes/disparo.png")
        self.rect = self.image.get_rect()
...
class Malo_random (pygame.sprite.Sprite):
    ...
    def __init__(self,disparos_malos,grupo_sprite,sonido_dism):
        ...
        if self.eleccion <= 50:
            self.image = carga_imagenes("imagenes/mysteryb.ico",True)
        if self.eleccion <= 100 and self.eleccion > 50:
            self.image = carga_imagenes("imagenes/mysterya.ico",True)
        self.rect = self.image.get_rect()
...
class Explosion (pygame.sprite.Sprite):
    ...
    def __init__(self,x,y):
        pygame.sprite.Sprite.__init__(self)
        self.image = carga_imagenes("imagenes/explosion.png",True)
        self.rect = self.image.get_rect()
        self.rect.centery = y
        self.rect.centerx = x
        self.delay = 3
...
class Ventanas (Text):
    ...
    def __init__(self):
        ...
        self.background_image = carga_imagenes('imagenes/fondo.jpg')
...
def carga_musica(filename):
    try: sound = pygame.mixer.Sound(filename)
    except pygame.error, message:
...
def main():
    ...
    pygame.display.set_caption("Space")
    sonido_dis = carga_musica('sonidos/shoot.wav')
    sonido_dism = carga_musica('sonidos/ufo_highpitch.wav')
    sonido_exp = carga_musica('sonidos/explosion.wav')
    background_image = carga_imagenes('imagenes/fondo.jpg')
    pygame.mouse.set_visible(False)
    ...
    if ini == 1:
        ...
        while True:
            ...
            for hit in pygame.sprite.groupcollide(grupo_malos,disparos,1,1):
                (x,y) = hit.rect.center
                grupo_sprite.add(Explosion(x,y))
                sonido_exp.play()
                puntos = puntos+(10*nivel)
            
            for hit in pygame.sprite.groupcollide(grupo_buenos,disparos_malos,1,1):
                (x,y) = hit.rect.center
                grupo_sprite.add(Explosion(x,y))
                sonido_exp.play()
                muerto = 1
